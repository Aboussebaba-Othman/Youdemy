    ...
    <div class="flex h-screen">
        <div class="w-64 bg-white shadow-md">
            ...
            <nav class="mt-4">
                ...
                <a href="user/home.php" class="flex items-center px-4 py-3 hover:bg-blue-50 text-gray-700 hover:text-blue-600">
                    <i class="fas fa-users w-6"></i>
                    <span>Gestion Utilisateurs</span>
                </a>
                <a href="cour/home.php" class="flex items-center px-4 py-3 hover:bg-blue-50 text-gray-700 hover:text-blue-600">
                    <i class="fas fa-book w-6"></i>
                    <span>Gestion Cours</span>
                </a>
                <a href="tag/home.php" class="flex items-center px-4 py-3 hover:bg-blue-50 text-gray-700 hover:text-blue-600">
                    <i class="fas fa-tags w-6"></i>
                    <span>Gestion Tags</span>
                </a>
                <a href="categorie/home.php" class="flex items-center px-4 py-3 hover:bg-blue-50 text-gray-700 hover:text-blue-600">
                    <i class="fas fa-folder w-6"></i>
                    <span>Gestion Catégories</span>
                </a>
                <a href="validation/home.php" class="flex items-center px-4 py-3 hover:bg-blue-50 text-gray-700 hover:text-blue-600">
        ...
        <div class="flex-1 overflow-y-auto p-8 bg-gray-50">
            <header class="flex justify-between items-center mb-8">
                ...
                <div class="flex items-center">
                    <input type="text" placeholder="Rechercher..." class="px-4 py-2 border rounded-lg mr-4 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                    <div class="flex items-center">
